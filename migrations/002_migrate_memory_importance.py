...
class RecalculateMemoryImportance(MemoryDataMigration):
    ...
    async def transform_memory(self, memory: dict[str, Any]) -> BulkMemoryItem | None:
        ...
        importance_score = await self._calculate_importance(content, metadata, created_at, last_accessed)
    ...
    async def _calculate_importance(
        ...
        importance = content_quality * 0.40 + temporal_relevance * 0.25 + access_score * 0.20 + uniqueness * 0.15
