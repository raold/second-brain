...
async def demo_importance_scoring():
    ...
    test_contents = [
        ...
        {
            "name": "Simple Note",
            "content": "Remember to update the API documentation",
    ...
    print(f"\n   💡 Explanation:")
    print(f"      • Procedural memories (processes/workflows) are most important")
    print(f"      • Semantic memories (facts/knowledge) have standard importance")
    print(f"      • Episodic memories (experiences) decay faster but can surge with access")
