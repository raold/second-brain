...
class ImportanceSystemTester:
    ...
    async def test_store_memory_with_importance(self):
        ...
        test_memories = [
            ...
            {
                "content": "Quick note about API endpoint",
    ...
    async def test_importance_breakdown(self):
        ...
        response = await self.client.get(
            f"{self.base_url}/api/importance/memory/{self.test_memory_id}/breakdown"
        )
    ...
    async def test_high_importance_memories(self):
        ...
        response = await self.client.get(
            f"{self.base_url}/api/importance/high-importance",
            params={"limit": 5}
        )
    ...
    async def test_importance_recalculation(self):
        ...
        response = await self.client.post(
            f"{self.base_url}/api/importance/recalculate",
            params={"limit": 10}
        )
    ...
    async def test_content_quality_scoring(self):
        ...
        content_samples = [
            ...
            },
            {
                ...
                "content": "Remember to update the README file",
                "expected": "low"
            }
        ]
