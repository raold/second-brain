...
def test_migration_api_routes():
    ...
    try:
        ...
        return {
            "success": True,
            "message": "Migration routes imported successfully",
            "route_count": len(router.routes)
        }
    except Exception as e:
        return {
            "success": False,
            "message": f"Failed to import migration routes: {e}"
        }
    ...
    for migration_file in migration_files:
        try:
            ...
            tests.append({
                "name": migration_file,
                "success": True,
                "message": f"File exists ({file_path.stat().st_size} bytes)"
            })
...
def test_dashboard_integration():
    ...
    try:
        ...
        return {
            ...
            "methods": [
                method for method in dir(dashboard) 
