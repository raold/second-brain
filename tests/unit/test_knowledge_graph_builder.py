...
class TestKnowledgeGraphBuilder:
    ...
    def test_is_likely_entity(self, graph_builder):
        ...
        # Valid entities
        assert graph_builder._is_likely_entity("John Smith")
        assert graph_builder._is_likely_entity("OpenAI")
        assert graph_builder._is_likely_entity("organization")

        # Not entities
        assert not graph_builder._is_likely_entity("the")
        assert not graph_builder._is_likely_entity("")
        assert not graph_builder._is_likely_entity("   ")
        assert not graph_builder._is_likely_entity("123")
