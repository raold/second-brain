...
class MigrationEngine:
    ...
    async def execute_migration(self, migration_id: str, config: MigrationConfig = None) -> MigrationResult:
    ...
    async def get_migration_progress(self, migration_id: str) -> dict[str, Any] | None:
        ...
        if migration_id in self.running_migrations:
            ...
            return {"migration_id": migration_id, "status": "running", "checkpoint": checkpoint}
