...
class GoogleDriveClient:
    ...
    async def get_file_info(self, file_id: str) -> DriveFile:
        ...
        return DriveFile(
            ...
            created_time=datetime.fromisoformat(file_metadata['createdTime'].replace('Z', '+00:00')) if 'createdTime' in file_metadata else None,
            modified_time=datetime.fromisoformat(file_metadata['modifiedTime'].replace('Z', '+00:00')) if 'modifiedTime' in file_metadata else None,
