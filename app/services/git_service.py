        ...
        try:
            ...
            return {
                ...
                'most_active_branches': {
                    ...
                    '7d': max([b for b in branch_metrics if b['commits_7d'] > 0], key=lambda x: x['commits_7d'], default=None),
                    '30d': max([b for b in branch_metrics if b['commits_30d'] > 0], key=lambda x: x['commits_30d'], default=None)
                }
            }
            ...
            return {
                'repository_totals': {
                    'commits_24h': 0, 'commits_7d': 0, 'commits_30d': 0,
                    'lines_added_24h': 0, 'lines_added_7d': 0, 'lines_added_30d': 0
                },
                'branch_activity': [],
