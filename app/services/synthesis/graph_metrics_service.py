...
class GraphMetricsService:
    ...
    async def analyze_node_importance(self, memory_id: UUID) -> NodeMetrics:
        ...
        try:
            ...
            degree_cent = nx.degree_centrality(graph)[memory_id]
            ...
            local_clustering = nx.clustering(graph, memory_id)
    ...
    async def _build_knowledge_graph(self, memory_ids: Optional[List[UUID]] = None) -> nx.Graph:
    ...
    async def _fetch_graph_memories(self, memory_ids: Optional[List[UUID]]) -> List[Dict[str, Any]]:
    ...
    async def _fetch_relationships(self, memory_ids: Optional[List[UUID]]) -> List[Dict[str, Any]]:
