...
router = APIRouter(tags=["System"], responses={503: {"description": "Service unavailable"}})
...
async def health_check():
    ...
    """
    checks = {"memory_service": check_memory_service(), "storage": check_storage()}
...
@router.get(
    "/health/live", summary="Liveness probe", description="Simple liveness check for Kubernetes"
)
...
async def readiness_probe():
    ...
    return ReadinessCheck(ready=is_ready, services=services, message="All services operational")
...
async def get_degradation_status():
    ...
    try:
        ...
        return {"error": str(e), "level": "UNKNOWN", "features_disabled": []}


@router.get("/info", summary="System information", description="Get detailed system information")
