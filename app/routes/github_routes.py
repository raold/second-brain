...
async def get_repository_info():
    ...
    try:
        ...
        return {
            "status": "success",
            "repository": {"name": root_path.name, "path": str(root_path), "git": git_info},
            "statistics": {
            ...
            "structure": {
                "main_directories": [d.name for d in root_path.iterdir() if d.is_dir() and not d.name.startswith(".")][
                    :10
                ]
            },
        }
