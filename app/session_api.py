    ...
    try:
        ...
        return {
            ...
            "productivity_snapshot": {
                "session_duration": session_manager.calculate_session_duration() if session_manager.current_session else "0m",
...
async def mobile_idea_quick_drop(
    idea: str = Form(...), 
    voice_note: Optional[str] = Form(default=None)
):
    """
