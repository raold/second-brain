...
class ConnectionMonitor:
    ...
    async def _collect_stats(self):
        ...
        if self.stats.active_connections > self.pool_manager.config.max_connections * 0.8:
            logging.warning(f"High connection usage: {self.stats.active_connections}/{self.pool_manager.config.max_connections}")
...
class DatabasePoolManager:
    ...
    async def optimize_pool(self):
        ...
        avg_active = stats.pool_acquisitions / max(1, stats.total_queries)
