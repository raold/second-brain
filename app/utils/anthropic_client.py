...
def analyze_with_claude(
    content: str, analysis_type: str = "general", model: str = "claude-3-opus-20240229"
) -> dict | None:
    ...
    if result:
        return {"analysis_type": analysis_type, "model": model, "result": result}
    return None


def compare_ai_models(prompt: str, openai_client=None, anthropic_client=None) -> dict:
...
def generate_memory_insights(memory_content: str) -> dict | None:
