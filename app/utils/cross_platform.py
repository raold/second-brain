...
class PlatformHelper:
    ...
    def _find_project_root(self) -> Path:
        ...
        possible_paths = [
            ...
            # macOS
            Path(
                "/Users/dro/Library/CloudStorage/GoogleDrive-dro@lynchburgsmiles.com/My Drive/projects/second-brain"
            ),
    ...
    def normalize_path(self, path: Union[str, Path]) -> Path:
        ...
        if str(path).startswith("G:\\") or str(path).startswith("G:/"):
            if not self.is_windows:
                ...
                if self.is_mac:
                    return Path(
                        "/Users/dro/Library/CloudStorage/GoogleDrive-dro@lynchburgsmiles.com/My Drive"
                    ) / relative.lstrip("/\\")
                else:
...
def get_google_drive_status() -> dict:
    ...
    return {
        ...
        "is_google_drive": "GoogleDrive" in str(project_root)
        or "Google Drive" in str(project_root)
        or "My Drive" in str(project_root),
